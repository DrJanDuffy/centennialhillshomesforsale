...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const priceData = {
    ...
    values: [600000,620000,610000,630000,640000,650000,660000,655000,670000,680000,690000,700000]
  };
  ...
  // Initialize charts
  const priceChart = makeChart(document.getElementById('chart-price'), 'Average Sale Price', priceData);
  const invChart = makeChart(document.getElementById('chart-inventory'), 'Active Listings', inventoryData);
