...
const enhancedBusinessData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "url": "https://centennialhillshomesforsale.com",
      "name": "Centennial Hills Homes | Providence & Skye Canyon | Dr. Jan Duffy, REALTOR®",
      "description": "Find homes for sale in Centennial Hills, Providence, and Skye Canyon. Expert real estate services by Dr. Jan Duffy, REALTOR®",
      "publisher": {
        "@id": "https://centennialhillshomesforsale.com/#organization"
      },
      "potentialAction": [
        {
          ...
          "target": {
            "@type": "EntryPoint",
            "urlTemplate": "https://centennialhillshomesforsale.com/listings?search={search_term_string}"
          },
