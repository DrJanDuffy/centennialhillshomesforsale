...
const siteConfig = {
  ...
  businessDescription:
    'Looking for homes for sale in North Las Vegas, Centennial Hills, or Lone Mountain? Dr. Jan Duffy, REALTOR® with Berkshire Hathaway HomeServices, is your trusted expert in luxury and new-build Las Vegas homes. With 20+ years of experience in master-planned communities, Dr. Duffy specializes in top neighborhoods like Skye Canyon, Providence, Aliante, Centennial Hills, Tule Springs, El Dorado, Lone Mountain, and Summerlin. Ranked in the Top 1% of Las Vegas REALTORS®, Dr. Duffy offers expert guidance, same-day showings, and a free market analysis. Available 24/7, Dr. Duffy provides personalized service to make buying or selling your Las Vegas home easy.',
  specialties: [
    'Building lot sales',
...
function generateEnhancedRealEstateAgentSchema() {
  return {
    ...
    openingHours: Object.entries(siteConfig.businessHours).map(
      ([day, hours]) =>
...
function generateServiceAreaSchema() {
  return {
    ...
    description:
      'Comprehensive real estate services covering buying, selling, and property management in Centennial Hills and surrounding areas',
    provider: {
      '@type': 'RealEstateAgent',
      name: siteConfig.agentName,
      url: siteConfig.baseUrl,
...
function generateSchemaForPage(pageType, _additionalData = {}) {
  const baseSchemas = [
  ...
  switch (pageType) {
    case 'home':
      return [...baseSchemas, generateEnhancedMarketDataSchema(), generateServiceAreaSchema()];
    case 'listings':
      return [
        ...baseSchemas,
        {
    ...
    case 'market-update':
      return [...baseSchemas, generateEnhancedMarketDataSchema()];
    case 'neighborhoods':
      return [...baseSchemas, generateServiceAreaSchema()];
    default:
      return baseSchemas;
  }
}
...
console.log(
  'Use this in your pages by importing: const { generateSchemaForPage } = require("../scripts/generate-schema");'
);
