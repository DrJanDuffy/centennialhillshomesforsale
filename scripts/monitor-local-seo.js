  ...
  const report = {
    ...
    napConsistency: {
      ...
      variations: {
        ...
        phoneFormats: ['(702) 903-1952', '702-903-1952', '7029031952', '+1-702-903-1952'],
      },
      consistencyScore: 95,
    },
      ...
      conversationalQueries: [
        {
          ...
          optimizedAnswer:
            'Dr. Jan Duffy is a top-rated REALTOR® in Centennial Hills with 30+ years experience, 4.9/5 rating, and expertise in Providence, Skye Canyon luxury homes.',
        ...
        },
        {
          ...
          optimizedAnswer:
            'Providence Las Vegas homes range from $450,000-$800,000. This master-planned community offers family-friendly amenities, top-rated schools, and easy access to Downtown Summerlin.',
          keywords: [
            'Providence Las Vegas home prices',
            '$450,000-$800,000',
        ...
        },
        {
          ...
          optimizedAnswer:
            'Both offer excellent value. Skye Canyon ($550K-$1.2M) features mountain views and custom homes. Centennial Hills ($450K-$800K) offers more affordable family communities with great schools.',
      ...
      featuredSnippets: [
        {
          ...
          answer:
            'The median home price in Centennial Hills is $635,000 as of 2024, with homes ranging from $300,000 to over $2 million.',
          structured: true,
        },
        {
          question: 'How long do homes stay on market in Las Vegas?',
          answer:
            "Homes in Centennial Hills typically sell within 28 days on average, making it a competitive seller's market.",
          structured: true,
        },
      ],
