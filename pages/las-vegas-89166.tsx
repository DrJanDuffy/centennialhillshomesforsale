The code imports RealScoutListings component and adjust related import statements.
```
```typescript
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Find homes for sale in Las Vegas 89166 zip code. Includes Skye Canyon master-planned community, new construction, and family amenities." />
        <meta name="keywords" content="89166 homes for sale, Las Vegas 89166, Skye Canyon real estate, new construction Las Vegas, family communities" />
        ...
        >
          <div className="container">
            ...
            <p className="hero-subtitle">
              Explore new construction and established homes in Las Vegas zip code 89166, 
              featuring the award-winning Skye Canyon community and family-friendly neighborhoods.
            </p>
          </div>
        </motion.section>
            ...
            <div className="overview-grid">
              ...
              <div className="zip-stats">
                ...
                <ul>
                  ...
                  <li><strong>Median Income:</strong> $78,000</li>
                  <li><strong>Median Home Value:</strong> $590,000</li>
                  <li><strong>Major Community:</strong> Skye Canyon</li>
                  <li><strong>Development:</strong> Ongoing new construction</li>
                </ul>
              </div>
            </div>
          </div>
