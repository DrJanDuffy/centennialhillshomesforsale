              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-lg text-gray-600 mb-6">
                    Dr. Jan Duffy is a Top 1% REALTOR® with over 20 years of experience in the Las Vegas real estate market. She specializes in luxury homes and master-planned communities, particularly in the Centennial Hills area.
                  </p>
                  <p className="text-lg text-gray-600 mb-6">
                    With a deep understanding of the local market and a commitment to exceptional service, Dr. Duffy has helped hundreds of families find their dream homes in this beautiful northwest Las Vegas community.
                  </p>
                  <p className="text-lg text-gray-600">
                    Her expertise extends beyond just buying and selling homes - she provides comprehensive guidance on market trends, investment opportunities, and the unique benefits of living in Centennial Hills.
                  </p>
                </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-gray-600">Consistently ranked in the top 1% of all REALTORS® in the Las Vegas Valley</p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-gray-600">Member of the prestigious Million Dollar Club for exceptional sales performance</p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-gray-600">Over two decades of real estate expertise in the Las Vegas market</p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-gray-600">Exceptional client satisfaction rate based on hundreds of successful transactions</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-50 rounded-lg p-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      <strong>High-End Properties:</strong> Specialized in luxury estates and premium homes
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3"></span>
                    <div>
                      <strong>Mountain Views:</strong> Expertise in properties with stunning mountain vistas
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-purple-500 rounded-full mt-2 mr-3"></span>
                    <div>
                      <strong>Custom Features:</strong> Knowledge of luxury amenities and custom finishes
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-orange-500 rounded-full mt-2 mr-3"></span>
                    <div>
                      <strong>Investment Properties:</strong> Guidance on high-value real estate investments
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-8">
                <h3 className="text-2xl font-bold mb-6 text-gray-800">Master-Planned Communities</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3"></span>
                    <div>
                      <strong>Providence:</strong> Deep knowledge of this luxury master-planned community
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3"></span>
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-purple-500 rounded-full mt-2 mr-3"></span>
                    <div>
                      <strong>Community Amenities:</strong> Understanding of lifestyle benefits and facilities
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-orange-500 rounded-full mt-2 mr-3"></span>
                    <div>
                      <strong>Future Development:</strong> Insights into upcoming community expansions
                    </div>
                  </li>
                </ul>
              </div>
        ...
        <section className="py-16 bg-blue-900 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Experience the difference that 20+ years of expertise and top-tier service can make in your real estate journey
            </p>
