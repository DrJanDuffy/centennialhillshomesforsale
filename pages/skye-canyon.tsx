  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Explore homes for sale in Skye Canyon Las Vegas. Newer master-planned community with family amenities, parks, and new construction. Browse current listings."
        />
        <meta
          name="keywords"
        ...
        >
          <div className="container">
            ...
            <p className="hero-subtitle">
              Discover modern family living in one of Las Vegas&apos;s newest master-planned
              communities. Featuring new construction homes, world-class amenities, and mountain
              views.
            </p>
          </div>
        </motion.section>
            ...
            <div className="overview-grid">
              <div className="overview-content">
                <p>
                  ...
                  one of Las Vegas&apos;s most sought-after neighborhoods. With its family-focused
                  amenities, stunning mountain views, and modern homes, Skye Canyon offers the
                ...
                <p>
                  ...
                  recreation center, pools, sports courts, and extensive trail system. New
                  construction homes range from $400K to $1.2M, offering something for every family.
                </p>
              </div>
              <div className="quick-stats">
                ...
                <ul>
                  <li>
                    <strong>Zip Code:</strong> 89166
                  </li>
                  <li>
                    <strong>Median Home Price:</strong> $590,000
                  </li>
                  <li>
                    <strong>Average Square Feet:</strong> 2,700
                  </li>
                  <li>
                    <strong>Built:</strong> 2010-2024
                  </li>
                  <li>
                    <strong>Population:</strong> ~35,000
                  </li>
                </ul>
              </div>
            </div>
