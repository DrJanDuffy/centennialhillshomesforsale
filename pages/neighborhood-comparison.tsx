  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Compare Centennial Hills neighborhoods side-by-side. Median prices, schools, amenities, and lifestyle factors for Tournament Hills, The Trails, Providence, and Skye Canyon."
        />
        <meta
          name="keywords"
          content="Centennial Hills neighborhood comparison, Las Vegas real estate comparison, Tournament Hills vs The Trails, Providence vs Skye Canyon"
        />
      ...
      <main>
        ...
        <section className="bg-gradient-to-r from-purple-900 to-purple-700 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Neighborhood Comparison</h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Compare Centennial Hills neighborhoods to find the perfect community for your
              lifestyle
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">Detailed Neighborhood Profiles</h2>
        ...
        <section className="py-16 bg-purple-900 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Need Help Choosing the Right Neighborhood?</h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Let Dr. Jan Duffy guide you through the Centennial Hills communities to find your
              perfect home
            </p>
