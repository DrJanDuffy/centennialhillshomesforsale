  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore the unique neighborhoods of Centennial Hills, Las Vegas. Discover Providence, Skye Canyon, and other master-planned communities with luxury amenities."
        />
        <meta
          name="keywords"
          content="Centennial Hills neighborhoods, Providence Las Vegas, Skye Canyon, northwest Las Vegas communities, master-planned communities"
        />
      ...
      <Layout>
        ...
        <section className="bg-gradient-to-r from-green-900 to-green-700 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Centennial Hills Neighborhoods</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Convenient access to shopping, dining, entertainment, and major highways while
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Master-planned communities with excellent schools, parks, and recreational
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Strong appreciation potential with growing demand for homes in this desirable
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Browse current listings in Providence, Skye Canyon, and other Centennial Hills
                communities
              </p>
            </div>
        ...
        <section className="py-16 bg-green-900 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Ready to Explore These Neighborhoods?</h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Let Dr. Jan Duffy show you around and help you find the perfect area for your
              lifestyle
            </p>
