...
const neighborhoodData: Record<NeighborhoodName, {
  ...
  'Tournament Hills': {
    ...
    zipCodes: ['89149'],
    coordinates: { lat: 36.280, lng: -115.340 }
  },
  'Skye Canyon': {
    ...
    zipCodes: ['89166'],
    coordinates: { lat: 36.285, lng: -115.350 }
  },
  'Sun City Aliante': {
    ...
    zipCodes: ['89084'],
    coordinates: { lat: 36.290, lng: -115.370 }
  }
};
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Explore neighborhoods in Centennial Hills including The Trails, Tournament Hills, Skye Canyon. Find homes, schools, and amenities in each area." />
        <meta name="keywords" content="Centennial Hills neighborhoods, The Trails Las Vegas, Tournament Hills homes, Skye Canyon community, Sun City Aliante" />
      ...
      <main className="container">
        ...
        >
          ...
          <p>
            Discover the unique character and amenities of each neighborhood in the greater Centennial Hills area. 
            From established communities to new master-planned developments, find your perfect Las Vegas home.
          </p>
        </motion.section>
