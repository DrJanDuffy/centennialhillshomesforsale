  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Sorry, we couldn't find the page you're looking for. Browse our properties, explore neighborhoods, or contact Dr. Jan Duffy for assistance." />
