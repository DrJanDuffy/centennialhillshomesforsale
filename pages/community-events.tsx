...
const communityEvents: CommunityEvent[] = [
  {
    ...
    description: "Weekly farmers market featuring local produce, artisanal goods, and community vendors. Enjoy live music and family activities.",
    date: "2024-09-15",
  ...
  },
  {
    ...
    description: "Professional golf tournament featuring PGA Tour players competing on the championship TPC Las Vegas course.",
    date: "2024-10-20",
  ...
  },
  {
    ...
    description: "Annual self-guided tour of beautifully landscaped homes and gardens in Centennial Hills. Proceeds benefit local schools.",
    date: "2024-11-10",
  ...
  },
  {
    ...
    description: "Community holiday celebration with tree lighting, carol singing, hot cocoa, and Santa visits for children.",
    date: "2024-12-01",
  ...
  },
  {
    ...
    description: "Annual 5K run/walk through Centennial Hills featuring scenic routes and community support. All ages welcome.",
    date: "2025-04-15",
  ...
  },
  {
    ...
    description: "End of summer celebration for families with school supply giveaways, face painting, games, and community resources.",
    date: "2024-08-25",
...
export default function CommunityEvents() {
  ...
  const filteredEvents = communityEvents.filter(event => {
    ...
    const matchesMonth = selectedMonth === "All Months" || eventDate.toLocaleString('default', { month: 'long' }) === selectedMonth;
    return matchesCategory && matchesMonth;
  });

  const featuredEvents = communityEvents.filter(event => event.featured);
  const months = ["All Months", ...new Set(communityEvents.map(event =>
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Stay connected with Centennial Hills community events, festivals, tournaments, and local activities. Farmers markets, golf tournaments, and family events." />
        <meta name="keywords" content="Centennial Hills events, Las Vegas community calendar, farmers market, golf tournament, local activities, family events" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Calendar of community events and activities in Centennial Hills, Las Vegas",
        ...
        <section className="py-16 bg-green-900 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Subscribe to our community newsletter and get notified about upcoming events, local news, and neighborhood updates
            </p>
