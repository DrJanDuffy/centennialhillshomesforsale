...
export default function LocalBusinessOptimization() {
  ...
  return (
    <Layout>
      <Head>
        <title>Local Las Vegas Real Estate Expert | Dr. Jan Duffy REALTOR® | Centennial Hills</title>
        <meta name="description" content="Local Las Vegas real estate expert Dr. Jan Duffy serves Centennial Hills, Providence, Skye Canyon, and Summerlin. 30+ years experience, 4.9/5 rating, available 24/7." />
        <meta name="keywords" content="Las Vegas local realtor, Centennial Hills expert, Providence homes, Skye Canyon specialist, local real estate agent" />
        <link rel="canonical" href="https://centennialhillshomesforsale.com/local-business-optimization" />
      ...
      <main className="local-business-page">
        ...
        >
          <div className="container">
            ...
            <p className="lead">
              Dr. Jan Duffy - Serving Centennial Hills, Providence, Skye Canyon & Summerlin for 30+ Years
            </p>
            ...
            <div className="business-card">
              <div className="business-info">
                ...
                <div className="info-grid">
                  ...
                  <div className="info-item">
                    <FaStar />
                    <span>{businessInfo.rating} ({businessInfo.reviews} Reviews)</span>
                  </div>
                </div>
              </div>
            </div>
