  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore Centennial Hills, Las Vegas with our interactive area guide. Discover amenities, schools, shopping, and points of interest in this master-planned community."
        />
        <meta
          name="keywords"
          content="Centennial Hills area guide, interactive map Las Vegas, amenities northwest Las Vegas, schools shopping restaurants, Dr. Jan Duffy"
        />
      ...
      <Layout>
        ...
        <section className="bg-gradient-to-r from-orange-900 to-orange-700 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Area Explorer</h1>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Distance Guide</h2>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-800 mb-6">Properties in This Area</h2>
        ...
        <section className="py-16 bg-orange-900 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Ready to Explore Centennial Hills?</h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Let Dr. Jan Duffy show you around and help you discover the perfect location for your
              new home
            </p>
