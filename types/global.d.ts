declare global {
  ...
  namespace JSX {
    interface IntrinsicElements {
      ...
      'realscout-mortgage-calculator': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement> & {
        'agent-encoded-id'?: string;
        'sort-order'?: string;
        'listing-status'?: string;
        'neighborhood'?: string;
      ...
      'realscout-search': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement> & {
        'agent-encoded-id'?: string;
        'sort-order'?: string;
        'listing-status'?: string;
        'neighborhood'?: string;
      ...
      'realscout-market-analysis': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement> & {
        'agent-encoded-id'?: string;
        'sort-order'?: string;
        'listing-status'?: string;
        'neighborhood'?: string;
