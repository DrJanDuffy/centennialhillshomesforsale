  ...
  const footerSections = [
    {
      ...
      description:
        'Your trusted partner in finding the perfect home in Northwest Las Vegas. Expert real estate services with a personal touch.',
      links: [
    ...
    },
    {
      ...
      description:
        'Comprehensive real estate services across the most desirable neighborhoods in Northwest Las Vegas.',
      links: [
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      icon: Facebook,
      href: 'https://facebook.com/centennialhillshomes',
      color: 'hover:text-blue-600',
    },
    {
      name: 'Twitter',
      icon: Twitter,
      href: 'https://twitter.com/centennialhills',
      color: 'hover:text-blue-400',
    },
    {
      name: 'Instagram',
      icon: Instagram,
      href: 'https://instagram.com/centennialhillshomes',
      color: 'hover:text-pink-500',
    },
    {
      name: 'LinkedIn',
      icon: Linkedin,
      href: 'https://linkedin.com/in/dr-jan-duffy',
      color: 'hover:text-blue-700',
    },
    {
      name: 'YouTube',
      icon: Youtube,
      href: 'https://youtube.com/centennialhillshomes',
      ...
      <div className="footer-content">
        ...
        {footerSections.map((section) => (
          <div key={section.title} className="footer-section">
            <h3>{section.title}</h3>
            <p className="text-sm text-white/70 mb-4 leading-relaxed">{section.description}</p>
            <nav>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-white/80">Las Vegas, Nevada</div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <p className="text-white/60 text-sm">
                © {currentYear} Centennial Hills Homes For Sale. All rights reserved. Made with ❤️ in
                Las Vegas.
              </p>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-white/10 text-center">
            <p className="text-white/50 text-xs">
              Dr. Jan Duffy is a licensed real estate professional in Nevada. All information
              provided is deemed reliable but not guaranteed. Please verify all information
              independently.
            </p>
          </div>
        </div>
