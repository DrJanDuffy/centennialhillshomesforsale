  ...
  return (
    <div className="citation-widget">
      ...
      <p className="citation-description">
        NAP (Name, Address, Phone) consistency across all platforms ensures better local search
        visibility.
      </p>
      ...
      <div className="nap-consistency">
        ...
        <div className="nap-details">
          <p>
            <strong>Business Name:</strong> Dr. Jan Duffy, REALTOR®
          </p>
          <p>
            <strong>Address:</strong> Providence Skye Canyon Dr, Las Vegas, NV 89166
          </p>
          <p>
            <strong>Phone:</strong> (702) 903-1952
          </p>
