...
const AdvancedSEOOptimizer: React.FC<AdvancedSEOOptimizerProps> = ({
    ...
    "review": [
      {
        ...
        "reviewBody": "Dr. Jan Duffy helped us find our dream home in Providence. Her knowledge of the Centennial Hills area is unmatched!"
      }
    ],
  ...
  const serviceSchema = {
    ...
    "description": "Comprehensive real estate services for buying and selling luxury homes in Centennial Hills",
    "provider": {
      "@type": "RealEstateAgent",
      "@id": `${siteUrl}/#realestateagent`
    },
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "itemOffered": {
            ...
            "description": "Professional marketing and sales services for Centennial Hills properties"
          }
        }
      ]
    }
