...
export default function GoogleBusinessProfileOptimizer({
  ...
  const reviewsSchema = {
    ...
    reviewBody:
      'Dr. Jan Duffy helped us find our dream home in Providence. Her knowledge of the Centennial Hills area is unmatched. Highly recommend!',
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="service-area"
          content="Centennial Hills, Providence, Skye Canyon, Las Vegas NV"
        />
        <meta name="primary-category" content="Real Estate Agent" />
        <meta
          name="business-attributes"
          content="Licensed, Insured, 30+ Years Experience, 4.9 Star Rating"
        />
      </Head>
      ...
      {showWidget && (
        <div className={'gbp-widget'}>
          <div className="gbp-header">
            <h3 className="">🏢 Dr. Jan Duffy, REALTOR®</h3>
          ...
          <div className="gbp-info">
            ...
            <p>
              🕒 Status:{' '}
              <span className={currentStatus === 'Open' ? styles.statusOpen : styles.statusClosed}>
                {currentStatus}
              </span>
            </p>
