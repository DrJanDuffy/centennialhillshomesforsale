...
export default function GoogleBusinessOptimization({ 
  ...
  const businessSchema = {
    ...
    "description": "Top-rated Las Vegas REALTOR® specializing in Centennial Hills, Providence, and Skye Canyon. 30+ years experience in luxury and new construction homes.",
        ...
        <div className="google-business-widget">
          <div className="business-info-card">
            ...
            <div className="business-details">
              ...
              <p>📞 <a href="tel:+17029031952">(702) 903-1952</a></p>
              <p>🕒 Status: <span className={`status ${businessHours.toLowerCase()}`}>{businessHours}</span></p>
