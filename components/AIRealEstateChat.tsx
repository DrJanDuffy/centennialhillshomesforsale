  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      type: 'assistant',
      content:
        "Hi! I'm your Centennial Hills real estate assistant. Ask me about listed prices, square footage, amenities, or commute times.",
      timestamp: new Date(),
    },
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        ...
        type: 'assistant',
        content:
          "I'm having trouble connecting right now. Please try again later or call 702-222-1964 for immediate assistance.",
        timestamp: new Date(),
      };
