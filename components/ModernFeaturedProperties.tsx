      ...
      <div className="container">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover exceptional homes in Centennial Hills with premium amenities and prime
            locations
          </p>
        </div>
              ...
              <div className="p-6 lg:p-8">
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-sm text-secondary-color font-semibold">
                      {property.neighborhood}
                    </span>
                  </div>
                  <h3 className="text-lg lg:text-xl font-bold text-primary-color line-clamp-2 leading-tight">
                    {property.address}
                  </h3>
                </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-primary-color to-primary-dark rounded-2xl p-8 lg:p-12 text-white">
            ...
            <p className="text-lg lg:text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Let us know what you&apos;re looking for and we&apos;ll find the perfect property for
              you in Centennial Hills.
            </p>
