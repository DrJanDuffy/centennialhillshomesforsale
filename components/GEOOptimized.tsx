...
export default function GEOOptimized({
    ...
    '@graph': [
      {
        ...
        description:
          'Licensed Nevada REALTOR® with 30+ years experience specializing in Centennial Hills, Providence, and Skye Canyon luxury real estate in Las Vegas.',
      ...
      },
      {
        ...
        description:
          'Premier real estate services specializing in Centennial Hills luxury homes, Providence family communities, and Skye Canyon mountain view properties.',
        url: 'https://centennialhillshomesforsale.com',
        telephone: '(702) 903-1952',
        ...
        image:
          'https://centennialhillshomesforsale.com/images/centennial-hills/centennial-hills-hero.jpg',
        serviceArea: {
          '@type': 'GeoCircle',
          geoMidpoint: {
            '@type': 'GeoCoordinates',
  ...
  return (
    <Head>
      ...
      <meta
        name="market-area"
        content="Centennial Hills, Providence, Skye Canyon, Las Vegas NV 89149"
      />
      ...
      <meta
        property="og:image"
        content="https://centennialhillshomesforsale.com/images/centennial-hills/centennial-hills-hero.jpg"
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Centennial Hills is a sought-after community in Las Vegas known for luxury homes, family amenities, and excellent schools.',
          }),
        }}
      />
    </Head>
