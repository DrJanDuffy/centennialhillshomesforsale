  ...
  return (
    <div className="conversion-funnel">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-gray-600">Engagement: {engagementScore} points</div>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="font-semibold">
                    Great progress! You're ready for the next step
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {currentStage === 'awareness' && <AwarenessStage onAction={trackAction} />}
        {currentStage === 'interest' && <InterestStage onAction={trackAction} />}
        {currentStage === 'consideration' && <ConsiderationStage onAction={trackAction} />}
        {currentStage === 'intent' && <IntentStage onAction={trackAction} />}
        {currentStage === 'purchase' && <PurchaseStage onAction={trackAction} />}
      </div>
    </div>
  );
};
...
const AwarenessStage: React.FC<{ onAction: (action: string) => void }> = ({ onAction }) => (
  <div className="text-center py-12">
    ...
    <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
      Discover luxury living in Las Vegas' most prestigious master-planned community. Let us help
...
const ConsiderationStage: React.FC<{ onAction: (action: string) => void }> = ({ onAction }) => (
  <div className="text-center py-12">
    ...
    <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
      You're seriously considering properties. Get a comprehensive market analysis to make an
      informed decision.
    </p>
...
const IntentStage: React.FC<{ onAction: (action: string) => void }> = ({ onAction }) => (
  <div className="text-center py-12">
    ...
    <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
      You're ready to take action! Let's discuss your offer strategy and get you into your dream
      home.
    </p>
...
const PurchaseStage: React.FC<{ onAction: (action: string) => void }> = ({ onAction }) => (
  <div className="text-center py-12">
    ...
    <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
      Thank you for choosing Dr. Jan Duffy as your real estate partner. We're here to help with all
