  ...
  "review": [
    {
      ...
      "reviewBody": "Dr. Duffy is the best real estate agent in Las Vegas. Her knowledge of the market and dedication to clients is unmatched."
    }
  ],
  "priceRange": "$$$",
...
export const ORGANIZATION_SCHEMA = {
  ...
  "description": "Premier real estate agency specializing in luxury homes and master-planned communities throughout the Las Vegas Valley",
  "url": "https://centennialhillshomesforsale.com/",
...
export const WEBSITE_SCHEMA = {
  ...
  "name": "Centennial Hills Homes for Sale",
  "description": "Your trusted source for luxury homes in Centennial Hills, Las Vegas. Expert real estate services from Dr. Jan Duffy, Top 1% REALTOR®.",
  "url": "https://centennialhillshomesforsale.com",
  "publisher": {
    "@type": "RealEstateAgent",
    "@id": "https://centennialhillshomesforsale.com/#realestateagent",
...
export const LOCAL_BUSINESS_SCHEMA = {
  ...
  "name": "Centennial Hills Homes for Sale",
  "description": "Premier real estate agency serving Centennial Hills and the greater Las Vegas area with luxury homes and expert guidance.",
  "url": "https://centennialhillshomesforsale.com/",
  "telephone": "(702) 903-1952",
  "email": "jan@centennialhillshomes.com",
  "address": {
