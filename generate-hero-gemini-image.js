...
/**
 * Generate Hero Image using Google Gemini 2.5 Flash Image Preview via OpenRouter
...
async function generateHeroImage() {
  console.log('🎨 Generating luxury hero image with Google Gemini 2.5 Flash Image Preview...\n');
