...
/**
 * Generate Hero Image using Google Gemini 2.5 Flash via OpenRouter (Correct Implementation)
 * This script uses the proper OpenRouter API format
 */
    ...
    if (data.choices && data.choices[0] && data.choices[0].message) {
      ...
      if (typeof messageContent === 'string') {
        ...
        if (urlMatch) {
          ...
          console.log('⚠️  No image found in response. This model may be for image analysis, not generation.');
