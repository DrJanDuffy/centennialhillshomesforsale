...
/**
 * Generate Enhanced Prompt using Google Gemini 2.5 Flash Lite via OpenRouter
...
async function generateEnhancedPrompt() {
  console.log('🎨 Generating enhanced prompt with Google Gemini 2.5 Flash Lite...\n');
  ...
  try {
    console.log('🚀 Sending request to OpenRouter with Gemini 2.5 Flash Lite...');
