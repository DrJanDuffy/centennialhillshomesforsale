...
document.addEventListener('DOMContentLoaded', function() {
    ...
    propertyCards.forEach(card => {
      ...
      if (propertyImage && propertyLink) {
        ...
        quickViewBtn.addEventListener('click', function(e) {
          ...
          const title = card.querySelector('.item-services__title')?.textContent || 'Property Details';
  ...
  const initNeighborhoodMap = () => {
    ...
    const mapPoints = [
      { lat: 36.243, lng: -115.2899, title: 'Centennial Hills', category: 'community', description: 'Family-friendly master-planned community' },
      { lat: 36.2755, lng: -115.3089, title: 'Skye Canyon', category: 'community', description: 'Active lifestyle community with outdoor focus' },
      { lat: 36.297, lng: -115.263, title: 'Providence', category: 'community', description: 'Quiet community with mountain views' },
      { lat: 36.224, lng: -115.2818, title: 'Centennial Hills Hospital', category: 'healthcare', description: '24-hour emergency care' },
      { lat: 36.24, lng: -115.292, title: 'Centennial Center', category: 'shopping', description: 'Premier shopping destination' },
      { lat: 36.261, lng: -115.283, title: 'Centennial Hills Park', category: 'recreation', description: 'Largest park in the area' }
    ];
  ...
  const initThemeSettings = () => {
    ...
    settingsButton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 1l9.5 5.5v11L12 23l-9.5-5.5v-11L12 1zm0 2.311L4.5 7.653v8.694l7.5 4.342 7.5-4.342V7.653L12 3.311zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0-2a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/></svg>';
  ...
  document.querySelectorAll('.page__main, .page__services, .page__about, .page__testimonial, .page__outro, .page__events, .page__market').forEach(section => {
